...
class Integration extends Component {
    ...
    getAuthorizeRequirements = async () => {
        const authorizeData = await this.api.getAuthorizeRequirements(
            this.type,
            'salesloft'
        );
    ...
    render() {
        ...
        const { name, description, icon } = display;
                ...
                {horizontal ? (
                    <Row className="integration-row">
                        ...
                        <Col md={8} className="integration-col-middle">
                            <p className="integration-name font-weight-bold">
                                {name}
                            </p>

                            <p className="integration-text">{description}</p>
                        </Col>

                        <Col className="integration-col-right">
                            {status && status === 'ENABLED' && (
                                <div className="integration-connected-portal">
                                    <label className="text-secondary integration-connected">
                                        Connected!
                                    </label>
                                    <br />

                                    <Link
                                        className="integration-disconnect-link"
                                        onClick={this.disconnectIntegration}
                                    >
                                        Disconnect?
                                    </Link>
                                    <Button
                                        onClick={this.enableModalForm}
                                        className={
                                            'integration-center-button-btn'
                                        }
                                    >
                                        Configure
                                    </Button>
                            ...
                            {status && status === 'NEEDS_CONFIG' && (
                                <div className="integration-connected-portal">
                                    ...
                                    <Button onClick={this.getSampleData}>
                                        Get Sample Data
                                    </Button>
                            ...
                            {status && status === 'PROCESSING' && (
                                <div className="integration-connected-portal">
                                    <label className="text-secondary integration-processing integration-connected">
                                        Processing
                                    </label>
                                    <br />
                            ...
                            {!status && (
                                <div className="integration-options-div">
                                    ...
                                    <Link
                                        to="#"
                                        className="integration-details-link"
                                    >
                                        Details
                                    </Link>
                                </div>
                    ...
                    <Col md={12} className="h-100 integration-col-parent">
                        <Row className="integration-row1-vertical">
                            <Image
                                src={icon}
                                className="mx-auto d-block integration-img-vertical"
                                height={125}
                                width={125}
                            />
                        </Row>
                        ...
                        <Row className="integration-row3-vertical">
                            {status && (
                                <label className="text-secondary integration-connected-vertical">
                                    Connected!
                                </label>
                            )}
                            {!status && (
                                <div className="integration-options-div-vertical">
                                    <Link
                                        to="#"
                                        className="integration-details-link-vertical"
                                    >
                                        Details
                                    </Link>
                                    <Button
                                        className="integration-connect-button-vertical"
                                        variant="primary"
                                    >
                                        Connect
                                    </Button>
