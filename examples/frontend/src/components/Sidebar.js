...
import { HomeIcon, UsersIcon, PuzzleIcon, AdjustmentsIcon, LogoutIcon } from '@heroicons/react/outline';
			...
			<div className="py-4 text-gray-500 dark:text-gray-400">
				...
				<ul className="mt-6">
					<li className="relative">
						<NavLink
							to="/dashboard"
							className="px-6 py-3 inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
							activeClassName="text-gray-800 dark:text-gray-100 border-l-8 border-purple-600"
						>
