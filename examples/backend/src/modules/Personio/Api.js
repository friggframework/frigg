const ApiKeyBase = require('../../base/auth/ApiKeyBase');
...
class PersonioAPI extends ApiKeyBase {
    constructor(params) {
        ...
        this.CLIENT_ID = this.getParam(params, 'clientId');
        this.CLIENT_SECRET = this.getParam(params, 'clientSecret');
        ...
        this.COMPANY_ID = this.getParam(params, 'companyId');
        this.SUBDOMAIN = this.getParam(params, 'subdomain');
        this.RECRUITING_API_KEY = this.getParam(
            params,
            'recruitingApiKey',
            null
        );
