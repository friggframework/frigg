...
class MarketoManager extends LHModuleManager {
    ...
    static async getInstance(params = {}) {
        ...
        // (Noting for posterity... this is definitely based on a different module that uses a tangled concept... should be cleaner and hence the refactor you'll see in the crossbeam API module. Also may benefit from just removing altogether from the Manager class and making it part of the LHModuleManager base class)
