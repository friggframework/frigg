...
class LHModuleManager extends LHDelegate {
    static Entity = Entity;
    static Credential = Credential;

    constructor(params) {
        super(params);
        this.userId = this.getParam(params, 'userId');
    ...
    static async getInstance(params) {
        throw new Error(
            'getInstance is not implemented. It is required for LHModuleManager. '
        );
    }
...
module.exports = LHModuleManager;
