...
// const LHDelegate = require('../../base/LHDelegate.js');
const LHRequester = require('../../base/LHRequester.js');
const FormatPatchBody = require('../../utils/FormatPatchBody.js');

class RevIoApi extends LHRequester {
    constructor(params) {
        super(params);
        this.USER_NAME = this.getParam(params, 'username', null);
        this.CLIENT_CODE = this.getParam(params, 'client_code', null);
    ...
    async getPaymentById(params) {
        const paymentId = this.getParam(params, 'id');
        const options = {
    ...
    async createPayment(params) {
        const customerId = this.getParam(params, 'customerId');
        const amount = this.getParam(params, 'amount');
        const referenceNumber = this.getParam(params, 'referenceNumber');
        const body = {
