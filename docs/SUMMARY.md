...
- [Contributing](contributing/contributing/README.md)
  - [Contributor Covenant Code of Conduct](contributing/contributing/code_of_conduct.md)
  - [PULL_REQUEST_TEMPLATE](contributing/contributing/pull_request_template.md)
...
- [API Module Library](api-module-library/module-list/README.md)
  ...
  - [BitBucket](api-module-library/module-list/bitbucket/README.md)
    - [Configuration](api-module-library/module-list/bitbucket/configuration.md)
    - [BitBucket Docs](https://developer.atlassian.com/cloud/bitbucket/rest)
