...
describe.skip("HubSpotApiClass API", () => {
  ...
  describe("Custom Schemas", () => {
    ...
    it("should get custom schema by type", async () => {
      let res = await hubSpotApi.getCustomObjectSchema(schema.objectTypeId);
    ...
    describe("Custom Objects", () => {
      beforeAll(async () => {
        ...
        obj = await hubSpotApi.createCustomObject(schema.objectTypeId, body);
      ...
      it("should get custom object by ID", async () => {
        let res = await hubSpotApi.getCustomObject(schema.objectTypeId, obj.id);
        res.should.have.property("id");
        res.should.have.property("properties");
        res.should.have.property("createdAt");
        res.should.have.property("updatedAt");
    ...
    describe("Bulk Custom Objects", () => {
      ...
      it("should list custom objects by species", async () => {
        const res = await hubSpotApi.listCustomObjects(schema.objectTypeId, {
          species: "Owl",
          properties: "species",
          limit: 1,
        });
