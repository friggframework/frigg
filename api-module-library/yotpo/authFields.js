const AuthFields = {
  ...
  uiSchema: {
    ...
    secret: {
      'ui:help':
              'Log into your Yotpo admin. At the top right corner of the screen, click the Profile icon. Select Store Settings. From your General Settings, click Get secret key. We’ll send an email with a verification code to the email address associated with your account.',
