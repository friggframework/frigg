...
class ZoomAPI extends OAuth2Base {
    constructor(params){
        super(params)
       ...
       this.authorizationUri = encodeURI(`https://zoom.us/oauth/authorize?client_id=${this.client_id}&response_type=code&redirect_uri=${this.redirect_uri}`);
