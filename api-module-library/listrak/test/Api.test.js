...
describe('Listrak API Requests', async () => {
    ...
    describe('Listrak Tickets', async () => {
        let ticket;
        before(async () => {
            const body = {
                messages: [
    ...
    describe('Listrak Customers', async () => {
        let customer;
        before(async () => {
            const body = {
                channels: [
    ...
    describe('Listrak Integrations', async () => {
        let integration;
        before(async () => {
            const body = {
    ...
    describe('Listrak Widgets', async () => {
        let widget;
        let logoUrl;
        before(async () => {
            const body = {
