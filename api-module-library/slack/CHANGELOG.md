...
- remove log line from Slack ([@brendanrmoore](https://github.com/brendanrmoore))
...
- add env var check to hide sensitive logs ([@brendanrmoore](https://github.com/brendanrmoore))
