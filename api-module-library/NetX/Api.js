...
class NetXAPI extends OAuth2Base {
  constructor(params) {
    super(params);
    ...
    this.authorizationUri = encodeURI(`${this.baseURL}/app?response_type=code&client_id=${this.client_id}&state=${this.state}&scope=${this.scope}&redirect_uri=${this.redirect_uri}#access/api`);
