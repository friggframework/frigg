...
/**
 * Find the nearest backend package.json file
 * This is a lightweight utility that doesn't require loading any Frigg modules
 * @returns {string|null} Path to the package.json file or null if not found
 */
...
/**
 * Validate that a backend path was found
 * @param {string|null} backendPath 
 * @throws {Error} If backend path is null
 */
