...
// Simplified version for quick help
const FALCON_ASCII = `
         .---.        .-----------
       /     \\  __  /    ------
      / /     \\(  )/    -----
...
// Compact version for verbose help (smaller than detailed)
...
const FALCON_ASCII_MINI = `
   /\\
  <##>
   \\/
`;

// Full detailed ASCII art for verbose help
const FALCON_ASCII_DETAILED = `
++                                          ###
++++                                      #####
++++++                                  #######
++++++++                              #########
...
// Abstract flying version
const FALCON_ASCII_FLYING = `
    _/\\_
   /=/\\=\\
  <=/  \\=>
   \\\\  //
...
// Alternative gradient design inspired by the #+++ art
const FALCON_ASCII_MODERN = `
    ##
   ####
  ######
 ###  ###
...
// Stylized with mixed characters
const FALCON_ASCII_STYLIZED = `
    ++
   +##+ 
  +####+
 +##  ##+
...
function displayLogo(style = 'default') {
    const logos = {
        default: FALCON_ASCII,
        mini: FALCON_ASCII_MINI,
        compact: FALCON_ASCII_COMPACT,
        large: FALCON_ASCII_LARGE,
        flying: FALCON_ASCII_FLYING,
        modern: FALCON_ASCII_MODERN,
        stylized: FALCON_ASCII_STYLIZED,
        detailed: FALCON_ASCII_DETAILED
    };
