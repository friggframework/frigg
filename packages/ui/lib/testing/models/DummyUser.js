 ...
 * Provides CRUD operations for test users in local development
 */
...
// Singleton instance
const dummyUserManager = new DummyUserManager();

export { DummyUser, DummyUserManager, dummyUserManager };