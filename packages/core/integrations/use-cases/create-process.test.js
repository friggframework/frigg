...
describe('CreateProcess', () => {
    ...
    describe('constructor', () => {
        it('should require processRepository', () => {
            expect(() => new CreateProcess({})).toThrow(
                'processRepository is required'
            );
        });

        it('should initialize with processRepository', () => {
            expect(createProcessUseCase.processRepository).toBe(
                mockProcessRepository
            );
        });
    });
    ...
    describe('execute', () => {
        ...
        it('should throw error if userId is missing', async () => {
            ...
            await expect(
                createProcessUseCase.execute(invalidData)
            ).rejects.toThrow(
                'Missing required fields for process creation: userId'
            );
        });
        ...
        it('should throw error if integrationId is missing', async () => {
            ...
            await expect(
                ...
                'Missing required fields for process creation: integrationId'
            );
        });
        ...
        it('should throw error if name is missing', async () => {
            ...
            await expect(
                ...
                'Missing required fields for process creation: name'
            );
        });
        ...
        it('should throw error if type is missing', async () => {
            ...
            await expect(
                ...
                'Missing required fields for process creation: type'
            );
        });
        ...
        it('should handle repository errors', async () => {
            ...
            await expect(
                createProcessUseCase.execute(validProcessData)
            ).rejects.toThrow(
                'Failed to create process: Database connection failed'
            );
        });
    });
});
