...
} from './get-database-state-via-worker-use-case';

describe('GetDatabaseStateViaWorkerUseCase', () => {
    let useCase: GetDatabaseStateViaWorkerUseCase;
    let mockLambdaInvoker: any;
    ...
    describe('constructor', () => {
        it('should require lambdaInvoker dependency', () => {
            expect(() => new GetDatabaseStateViaWorkerUseCase({ workerFunctionName } as any))
                .toThrow('lambdaInvoker dependency is required');
        });

        it('should require workerFunctionName dependency', () => {
            expect(() => new GetDatabaseStateViaWorkerUseCase({ lambdaInvoker: mockLambdaInvoker } as any))
