...
describe('encryption-schema-registry', () => {
    ...
    describe('getEncryptedFields', () => {
        ...
        it('returns plain array (not object with .fields property)', () => {
            ...
            expect((fields as any).fields).toBeUndefined();
        });
    });
    ...
    describe('validateCustomSchema', () => {
        ...
        it('rejects schema without fields array', () => {
            ...
            const result = validateCustomSchema(schema as any);
    ...
    describe('registerCustomSchema', () => {
        ...
        it('does nothing with null schema', () => {
            const beforeModels = getEncryptedModels();
            registerCustomSchema(null as any);
            const afterModels = getEncryptedModels();
    ...
    describe('loadModuleEncryptionSchemas', () => {
        it('loads encryption fields from API module definitions', () => {
            ...
            loadModuleEncryptionSchemas(integrations as any);
        ...
        it('handles integrations without encryption config', () => {
            ...
            expect(() => loadModuleEncryptionSchemas(integrations as any)).not.toThrow();
        });
        ...
        it('throws error for null/undefined integrations', () => {
            expect(() => loadModuleEncryptionSchemas(null as any)).toThrow('integrations parameter is required');
            expect(() => loadModuleEncryptionSchemas(undefined as any)).toThrow('integrations parameter is required');
        });

        it('throws error for non-array integrations', () => {
            expect(() => loadModuleEncryptionSchemas('not-an-array' as any)).toThrow('integrations must be an array');
            expect(() => loadModuleEncryptionSchemas({} as any)).toThrow('integrations must be an array');
        });
        ...
        it('merges module schemas with existing custom schemas', () => {
            ...
            const credentialFields = getEncryptedFields('Credential');
            expect(credentialFields).toContain('data.custom_field');
            expect(credentialFields).toContain('data.api_key');
        });
    });
});
