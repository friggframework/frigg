import { UpdateIntegrationStatus } from '../../use-cases/update-integration-status';
...
describe('UpdateIntegrationStatus Use-Case', () => {
    ...
    let useCase: InstanceType<typeof UpdateIntegrationStatus>;
    ...
    describe('happy path', () => {
        ...
        it('tracks status update operation', async () => {
            ...
            const updateOperation = history.find((op: any) => op.operation === 'updateStatus');
    ...
    describe('edge cases', () => {
        it('handles null status value', async () => {
            ...
            const result = await useCase.execute(record.id, null as any);
