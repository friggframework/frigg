...
import { ConfigCapturingIntegration } from '../doubles/config-capturing-integration';
...
describe('UpdateIntegration Use-Case', () => {
    ...
    let useCase: InstanceType<typeof UpdateIntegration>;
    ...
    describe('partial config update semantics (issue #514)', () => {
        let configCapturingUseCase: InstanceType<typeof UpdateIntegration>;
