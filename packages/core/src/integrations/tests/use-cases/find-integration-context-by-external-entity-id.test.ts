import { FindIntegrationContextByExternalEntityIdUseCase } from '../../use-cases/find-integration-context-by-external-entity-id';
import { TestModuleRepository } from '../../../modules/tests/doubles/test-module-repository';
...
describe('FindIntegrationContextByExternalEntityIdUseCase', () => {
    let moduleRepository: InstanceType<typeof TestModuleRepository>;
    let integrationRepository: InstanceType<typeof TestIntegrationRepository>;
    let loadIntegrationContextUseCase: any;
    let useCase: InstanceType<typeof FindIntegrationContextByExternalEntityIdUseCase>;
