import { UpdateIntegrationMessages } from '../../use-cases/update-integration-messages';
...
describe('UpdateIntegrationMessages Use-Case', () => {
    ...
    let useCase: InstanceType<typeof UpdateIntegrationMessages>;

    beforeEach(() => {
        integrationRepository = new TestIntegrationRepository();
        useCase = new UpdateIntegrationMessages({ integrationRepository } as any);
    });
    ...
    describe('happy path', () => {
        ...
        it('tracks message update operation', async () => {
            ...
            const updateOperation = history.find((op: any) => op.operation === 'updateMessages');
    ...
    describe('edge cases', () => {
        ...
        it('handles null and undefined values', async () => {
            ...
            await useCase.execute(record.id, 'warnings', null as any, undefined as any, null as any);
        ...
        it('handles special characters in messages', async () => {
            const record = await integrationRepository.createIntegration(['e1'], 'user-1', { type: 'dummy' });
            const specialTitle = '\u{1F6A8} Error with \u00e9mojis & sp\u00ebcial chars';
