...
describe('GetIntegrationInstance Use-Case', () => {
    ...
    let useCase: InstanceType<typeof GetIntegrationInstance>;
    ...
    describe('happy path', () => {
        it('returns hydrated integration instance', async () => {
            ...
            const instance = await useCase.execute(record.id, 'user-1') as any;
    ...
    describe('edge cases', () => {
        ...
        it('handles userId comparison edge cases', async () => {
            ...
            const instance1 = await useCase.execute(record.id, 'user-1') as any;
            const instance2 = await useCase.execute(record.id, 'user-1') as any;
