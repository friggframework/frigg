...
describe('DeleteIntegrationForUser Use-Case', () => {
    ...
    let useCase: InstanceType<typeof DeleteIntegrationForUser>;
    ...
    describe('happy path', () => {
        ...
        it('tracks delete operation', async () => {
            ...
            const deleteOperation = history.find((op: any) => op.operation === 'delete');
    ...
    describe('error cases', () => {
        ...
        it('tracks failed delete operation for non-existent integration', async () => {
            ...
            try {
                ...
                const history = integrationRepository.getOperationHistory();
                const findOperation = history.find((op: any) => op.operation === 'findById');
    ...
    describe('edge cases', () => {
        ...
        it('handles null userId gracefully', async () => {
            ...
            await expect(useCase.execute(record.id, null as any))
                .rejects
        ...
        it('handles undefined userId gracefully', async () => {
            ...
            await expect(useCase.execute(record.id, undefined as any))
                .rejects
