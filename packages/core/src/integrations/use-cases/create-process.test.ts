...
describe('CreateProcess', () => {
    let createProcessUseCase: InstanceType<typeof CreateProcess>;
    ...
    describe('constructor', () => {
        it('should require processRepository', () => {
            expect(() => new CreateProcess({} as any)).toThrow('processRepository is required');
        });

        it('should initialize with processRepository', () => {
            expect((createProcessUseCase as any).processRepository).toBe(mockProcessRepository);
        });
    });
    ...
    describe('execute', () => {
        ...
        it('should throw error if userId is missing', async () => {
            ...
            await expect(createProcessUseCase.execute(invalidData as any))
