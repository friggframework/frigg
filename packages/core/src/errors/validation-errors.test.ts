...
describe('RequiredPropertyError', () => {
    ...
    it('allows setting the parent of the error', () => {
        const error = new RequiredPropertyError({ parent: class Xyz {} } as RequiredPropertyErrorOptions);
        expect(error).toHaveProperty(
            'message',
        ...
        const error = new RequiredPropertyError(
            {
                parent: class Qrs {},
                key: 'def',
            } as RequiredPropertyErrorOptions,
...
describe('ParameterTypeError', () => {
    ...
    it('allows setting the parent of the error', () => {
        const error = new ParameterTypeError({ parent: class Xyz {} } as ParameterTypeErrorOptions);
        expect(error).toHaveProperty(
            'message',
    ...
    it('allows setting the expected type of the error', () => {
        const error = new ParameterTypeError({ expectedType: class Xyz {} } as ParameterTypeErrorOptions);
        expect(error).toHaveProperty(
            'message',
    ...
    it('allows setting the expected type of the error to Array', () => {
        const error = new ParameterTypeError({ expectedType: Array } as ParameterTypeErrorOptions);
        expect(error).toHaveProperty(
            'message',
