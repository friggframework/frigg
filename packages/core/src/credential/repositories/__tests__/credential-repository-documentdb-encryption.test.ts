...
} from '../credential-repository-documentdb';
import {
    DocumentDBEncryptionService,
} from '../../../database/documentdb-encryption-service';
...
describe('CredentialRepositoryDocumentDB - Encryption Integration', () => {
    let repository: InstanceType<typeof CredentialRepositoryDocumentDB>;
    ...
    beforeEach(() => {
        ...
        MockedDocumentDBEncryptionService.mockImplementation(
            () => mockEncryptionService
        );
    ...
    describe('Encryption on Upsert (UPDATE)', () => {
        ...
        it('preserves other credential fields during update', async () => {
            ...
            const updateCall = (mockedPrisma.$runCommandRaw as jest.Mock).mock.calls.find(
    ...
    describe('Edge Cases', () => {
        ...
        it('handles very large token values', async () => {
            const largeToken = 'a'.repeat(2000);
    ...
    describe('Security Validation', () => {
        ...
        it('ensures plain text returned to application after decryption', async () => {
            ...
            expect(result!.access_token).not.toMatch(/:/);
        });
