...
describe('LoginUser Use Case', () => {
    ...
    let loginUser: InstanceType<typeof LoginUser>;
    let userConfig: any;
    ...
    beforeEach(() => {
        ...
        loginUser = new LoginUser({ userRepository: userRepository as any, userConfig });
    ...
    describe('Bcrypt Hash Verification', () => {
        ...
        it('should verify bcrypt.compare is called with plain password and hash', async () => {
            ...
            const [firstArg, secondArg] = (bcrypt.compare as jest.Mock).mock.calls[0];
